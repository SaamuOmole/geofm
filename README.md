...
This is a BridgeAI project for [Amelia Space Technology](https://ameliaspace.com/). The project specifically explored the use of geospatial foundation models (GFMs) for a variety of tasks including water/flood segmentation, crop classification and change detection. The main tasks agreed include:
